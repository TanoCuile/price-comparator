...
const generateRandomObject = length => {
  let o = {};
...
function randJSON(options) {
  let objectSize = randNumber({
    min: (options == null ? void 0 : options.min) || 1,
    max: (options == null ? void 0 : options.max) || 99
  });
  if (options != null && options.length) objectSize = options.length;
...
function randCodeSnippet(options) {
  ...
  return fake(() => data$2[lang], options);
}
...
function randFlightNumber(options) {
  ...
  const airline = (_options$airline = options == null ? void 0 : options.airline) != null ? _options$airline : rand(data$1);
