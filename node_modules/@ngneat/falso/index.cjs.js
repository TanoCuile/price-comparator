...
var generateRandomObject = function generateRandomObject(length) {
  var o = {};
...
function randJSON(options) {
  var objectSize = randNumber({
    min: (options === null || options === void 0 ? void 0 : options.min) || 1,
    max: (options === null || options === void 0 ? void 0 : options.max) || 99
  });
  if (options === null || options === void 0 ? void 0 : options.length) objectSize = options.length;
...
function randFlightNumber(options) {
  ...
  var airline = (_a = options === null || options === void 0 ? void 0 : options.airline) !== null && _a !== void 0 ? _a : rand(data$1);
...
function randAirportName(options) {
  var factory = function factory() {
    return rand(data.map(function (_a) {
      var name = _a.name;
      return name;
    }));
  };
